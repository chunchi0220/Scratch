...
import usbmicrobitImage from './usbmicrobit/microbit.png';
import usbmicrobitInsetImage from './usbmicrobit/microbit-small.svg';
...
export default [
    ...
    {	
        name: (
            <FormattedMessage
                defaultMessage="USB micro:bit"
                description="Name for the 'USB micro:bit' extension"
                id="gui.extension.usbmicrobit.name"
            />
        ),
        extensionId: 'usbMicrobit',
        iconURL: usbmicrobitImage,
        insetIconURL: usbmicrobitInsetImage,
        description: (
            <FormattedMessage
                defaultMessage="USB micro:bit"
                description="Description for the 'USB micro:bit' extension"
